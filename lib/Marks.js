...
var Marks = function Marks(_ref) {
  ...
  var max = _ref.max;
  var min = _ref.min;
  var markStyler = _ref.markStyler;
  ...
  var elements = marksKeys.map(parseFloat).sort(function (a, b) {
    ...
    var style = markStyler ? markStyler(index, marksCount, point, defaultStyle) : defaultStyle;
    return _react2['default'].createElement(
      'span',
      { className: markClassName, style: style || defaultStyle, key: point },
      marks[point]
    );
  });
